...
# displayed. Also, code execution blocks waiting for the user's response to 
# the message box.
#
...
class mbox: 
    ...
    def error(self, message_text, threaded=False):
       return self.mbox(Gtk.MessageType.ERROR, message_text, "Error", Gtk.ButtonsType.CLOSE, threaded)
    ...
    def mbox_nt(self, msg_type, message_text, window_title, buttons):
        ...
        mbox.set_position(Gtk.WindowPosition.CENTER_ON_PARENT)
